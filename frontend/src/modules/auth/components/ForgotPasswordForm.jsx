    ...
    return (
      ...
      >
        ...
        <motion.button
          ...
          className="w-full py-3 bg-linear-to-r from-primary to-accent text-white font-medium rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-soft"
        >
